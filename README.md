...
Проект инициализирован и применен, входящие правила группы example_dynamic:
...
Созданы ВМ web-, а также main и replica:

![alt text](image-2.png)

Привязаны к группе безопасности:
...
Созданы 3 диска (disk-1-3) и подключены к вновь созданной ВМ storage:
...
Отредактирован код из ansible.tf под нужды задания, применен, создана конфигурация. 
...
Необходимое выражение в terraform console:
...
Пробел после "platform_id ", а также фигурная скобка должна закрываться после ["nat_ip_address"].

После исправления ошибка ушла:
